<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_SESSION['user_name']?> <b
                        class="caret"></b></a>
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#posts"><i class="fa fa-fw fa-arrows-v"></i>
                    Post <i class="fa fa-fw fa-caret-down"></i></a>
            ...
            <li>
                <!--<a  href='users.php?source=update_user&amp;user_id=<?php /*echo $user_id;*/?>>'><i class="fa fa-fw fa-dashboard"></i>Profile</a>-->
